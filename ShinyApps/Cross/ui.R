...
dashboardPage(
    ...
    dashboardSidebar(
        sidebarMenu(
            ...
            menuItem("Alloy Blogs", tabName = "blogs"),
    ...
    dashboardBody(tags$head(
        ...
        tabItem(tabName = "table", fluidRow(
            box(DT::DTOutput("table"), width = 6), box(plotOutput("pagewise"), width = 6)
        )),
        tabItem(tabName = "blogs",fluidRow(
            box(DT::DTOutput("blog_table"),width = 6),box(DT::DTOutput("blog_expanded"),width = 6)
        ))
